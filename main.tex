...
% Edição: Cesar Prada - Tese FCF-USP + Tiago Lubiana --> Bioinformática IME
%  
...
% Pacotes para formatação de citações --> 
\usepackage{csquotes}
...
\usepackage[pdftex,plainpages=false,pdfpagelabels,colorlinks=true,citecolor=DarkGreen,linkcolor=NavyBlue,urlcolor=DarkRed,filecolor=green,bookmarksopen=true]{hyperref} % links coloridos
...
%    \Large{Faculdade de Ciências Farmacêuticas\\
...
%    Área de Fisiopatologia}
    ...
    \vskip 2.5cm
    \textsc{
    Tese/Dissertação para obtenção do Título de \\[0.1cm] 
    DOUTOR/MESTRE EM CIÊNCIAS}
...
% ---------------------------------------------------------------------------- %
% Agradecimentos:
% Se o candidato não quer fazer agradecimentos, deve simplesmente eliminar este trecho
...
% ---------------------------------------------------------------------------- %
% Resumo
\input cap-resumo        % associado ao arquivo: 'cap-resumo.tex'
...
\input cap-objetivos        % associado ao arquivo: 'cap-objetivos.tex'
\input cap-metodos            % associado ao arquivo: 'cap-metodos.tex'
\input cap-resultados            % associado ao arquivo: 'cap-resultados.tex'
\input cap-discussao            % associado ao arquivo: 'cap-discussao.tex'
